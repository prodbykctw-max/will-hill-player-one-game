    ...
    day: {
      bg: {
        ...
        cards: [
          ...
          { key: 'mcdonalds', img: eavDayMcdonalds, depth: 0.50, span: [0.899, 0.979] },
  ...
  },
  {
    ...
    bg: {
      ...
      cards: [
        ...
        { key: 'facade', img: ewFacade, depth: 0.46, span: [0.000, 1.000] },
        { key: 'bay_left', img: ewBayLeft, depth: 0.47, span: [0.055, 0.243] },
        { key: 'bay_mid1', img: ewBayMid1, depth: 0.48, span: [0.368, 0.520] },
        { key: 'bay_mid2', img: ewBayMid2, depth: 0.49, span: [0.525, 0.658] },
        { key: 'bay_right', img: ewBayRight, depth: 0.47, span: [0.785, 0.935] },
        { key: 'sign_blm', img: ewSignBlm, depth: 0.48, span: [0.398, 0.490] },
        { key: 'sign_soul', img: ewSignSoul, depth: 0.50, span: [0.556, 0.630] },
        { key: 'neon_open', img: ewNeonOpen, depth: 0.50, span: [0.594, 0.653] },
    ...
    day: {
      bg: {
        ...
        cards: [
          ...
          { key: 'bay_mid1', img: edgewoodDayBayMid1, depth: 0.48, span: [0.367, 0.518] },
          { key: 'bay_mid2', img: edgewoodDayBayMid2, depth: 0.49, span: [0.522, 0.655] },
          { key: 'bay_right', img: edgewoodDayBayRight, depth: 0.47, span: [0.781, 0.929] },
          { key: 'sign_blm', img: edgewoodDaySignBlm, depth: 0.48, span: [0.396, 0.488] },
          { key: 'sign_soul', img: edgewoodDaySignSoul, depth: 0.50, span: [0.554, 0.627] },
          { key: 'neon_open', img: edgewoodDayNeonOpen, depth: 0.50, span: [0.592, 0.650] },
  ...
  },
  {
    ...
    bg: {
      ...
      cards: [
        ...
        { key: 'park', img: ugPark, depth: 0.50, span: [0.050, 0.116] },
        { key: 'peachtree', img: ugPeachtree, depth: 0.50, span: [0.826, 0.999] },
        { key: 'midbuild', img: ugMidbuild, depth: 0.50, span: [0.180, 0.657] },
        ...
        { key: 'shelter', img: ugShelter, depth: 0.50, span: [0.000, 0.182] },
        { key: 'arch', img: ugArch, depth: 0.50, span: [0.392, 0.592] },
        { key: 'columns', img: ugColumns, depth: 0.51, span: [0.349, 0.633] },
    ...
    day: {
      bg: {
        ...
        cards: [
          ...
          { key: 'shelter', img: ugdShelter, depth: 0.50, span: [0.000, 0.186] },
          { key: 'arch', img: ugdArch, depth: 0.50, span: [0.387, 0.639] },
          { key: 'columns', img: ugdColumns, depth: 0.51, span: [0.357, 0.635] },
  ...
  },
  {
    ...
    bg: {
      ...
      cards: [
        ...
        { key: 'sign', img: l5pSign, depth: 0.50, span: [0.445, 0.929] },
        { key: 'letters', img: l5pLetters, depth: 0.50, span: [0.500, 0.890] },
        { key: 'rightpillar', img: l5pRightpillar, depth: 0.50, span: [0.930, 1.000] },
        { key: 'newused', img: l5pNewused, depth: 0.50, span: [0.126, 0.301] },
        { key: 'newusedsign', img: l5pNewusedsign, depth: 0.50, span: [0.143, 0.299] },
        { key: 'brick', img: l5pBrick, depth: 0.50, span: [0.299, 0.453] },
        { key: 'buysell', img: l5pBuysell, depth: 0.50, span: [0.325, 0.397] },
        { key: 'bayleft', img: l5pBayleft, depth: 0.53, span: [0.442, 0.594] },
        { key: 'openneon', img: l5pOpenneon, depth: 0.54, span: [0.465, 0.532] },
        { key: 'baymid', img: l5pBaymid, depth: 0.55, span: [0.595, 0.717] },
    ...
    day: {
      bg: {
        ...
        cards: [
          ...
          { key: 'sign', img: l5pDaySign, depth: 0.50, span: [0.458, 0.936] },
          { key: 'letters', img: l5pDayLetters, depth: 0.50, span: [0.512, 0.897] },
          { key: 'rightpillar', img: l5pDayRightpillar, depth: 0.50, span: [0.937, 1.000] },
          { key: 'newused', img: l5pDayNewused, depth: 0.50, span: [0.143, 0.315] },
          { key: 'newusedsign', img: l5pDayNewusedsign, depth: 0.50, span: [0.160, 0.313] },
          { key: 'brick', img: l5pDayBrick, depth: 0.50, span: [0.313, 0.466] },
          { key: 'buysell', img: l5pDayBuysell, depth: 0.50, span: [0.339, 0.411] },
          { key: 'bayleft', img: l5pDayBayleft, depth: 0.53, span: [0.454, 0.605] },
          { key: 'openneon', img: l5pDayOpenneon, depth: 0.54, span: [0.478, 0.544] },
          { key: 'baymid', img: l5pDayBaymid, depth: 0.55, span: [0.606, 0.726] },
